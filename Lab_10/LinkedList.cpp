...
void LinkedList::insertAtFront(int initialValue)  //works the same way as insertAtBack, but in the opposite direction
{ 												 //exercise 2
	Node*temp = new Node();
...
bool LinkedList::removeFromFront()   //works the same way as removeFromBack, but in the opposite direction
{ 									//exercise2
	Node*temp = first;
	if (first == NULL){
		return false;
